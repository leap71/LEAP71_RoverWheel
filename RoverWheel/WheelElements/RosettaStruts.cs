...
namespace Leap71
{
	...
	namespace Rover
	{
		public class RosettaStruts : WheelElements
        {
			public RosettaStruts(	WheelLayer  oLayer,
									uint		nSymmetry,
            ...
            public override Voxels voxConstruct()
			{
				...
				{ 
                    for (int i = 0; i < m_nSymmetry; i++)
					{
						...
						Vector3 vecPt2		= VecOperations.vecGetCylPoint(fRefOuterRadius, fPhi, fZ);
						...
						aControlPoints.Add(vecPt1);
						aControlPoints.Add(vecPt1 + 0.6f * dR * vecRadial1);
						aControlPoints.Add(vecPt2);
						aControlPoints.Add(vecPt2);
						aControlPoints.Add(vecPt3 + 0.6f * dR * vecRadial3);
						aControlPoints.Add(vecPt3);
