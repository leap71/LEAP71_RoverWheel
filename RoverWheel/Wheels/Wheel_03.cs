...
namespace Leap71
{
    ...
    namespace Rover
    {
		public class Wheel_03 : RoverWheel
		{
            /// <summary>
            /// Generates a the third variant of the preset rover wheels.
            /// </summary>
            public Wheel_03()
			{
            ...
            public override Voxels voxConstruct()
            {
                ...
                WheelElements oElements_01  = new EgyptianStruts(sLayer_01, 16, 5);
                WheelElements oElements_02  = new RectHoles(sLayer_02, 20, 4);
                WheelElements oElements_03  = new TubeStruts(sLayer_03, 50, 2);
